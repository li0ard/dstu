...
- Еліптичні криві та ЕП (ДСТУ 4145-2002)
    - Підтримує поліноміальний і оптімальний нормальний базис
    - Підтримує ECDH та шифрування
...
- Шифр ДСТУ 9311:2024 (перевиданий ДСТУ ГОСТ 28147:2009)
- Геш-функція ГОСТ 34.311-95 на ДСТУ 9311:2024
    - Підтримує HMAC
...
- Захист ключових данних (KW)
    - Підтримує [`Dstu7624Wrap`/`GOST28147Wrap`](https://zakon.rada.gov.ua/laws/show/z0108-13)
