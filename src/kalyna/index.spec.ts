...
import { KEY128, KEY256, KEY512 } from "../modes/_test_utils.test";

test("[CORE] Kalyna-128/128", () => {
    const cipher = new Kalyna128(KEY128);
...
test("[CORE] Kalyna-128/256", () => {
    const cipher = new Kalyna128_256(KEY256);
...
test("[CORE] Kalyna-256/256", () => {
    const cipher = new Kalyna256(KEY256);
...
test("[CORE] Kalyna-256/512", () => {
    const cipher = new Kalyna256_512(KEY512);
...
test("[CORE] Kalyna-512/512", () => {
    const cipher = new Kalyna512(KEY512);
