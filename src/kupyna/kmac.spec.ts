...
import { copyBytes, hexToBytes } from "@noble/hashes/utils.js";
import { alphabet, KEY256, KEY512 } from "../modes/_test_utils.test";
...
describe("[KMAC] Kupyna", () => {
    ...
    test("256 bit", () => {
        ...
        const key = copyBytes(KEY256).reverse();
    ...
    test("512 bit", () => {
        ...
        const key = copyBytes(KEY512).reverse();
