...
describe("[CORE] DSTU 4145-2002 (PB)", () => {
    ...
    test("#2 (m=257)", () => {
        const privateKey = hexToBytes("7D46E42B36B76F551426CAFCECDD2F2ED1D7EA072CF0811564BF2DA75105BA9C");
    ...
    test("#3 (m=431)", () => {
        const privateKey = hexToBytes("3307AF47E9D37D53A9FCBF6D6E9E09340F580F903FE48A84BBF77B9794C0AC94F48ECB965F09CA0EF3FCB213B7185C5016109F288C6B");
